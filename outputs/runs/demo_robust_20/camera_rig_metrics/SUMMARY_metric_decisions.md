...
- Camera-rig metrics write to `camera_rig_metrics/` inside each run directory.
...
- The paired camera-rig design is valid because the audit found `5` matched scene indices and `20` sample folders.
...
- Camera-rig metrics recompute free-space certainty from the current depth captures on every non-audit run.
...
- Plot style file: `/Users/_iggnat_/Documents/TUe/Year 4/Q3/Team Internship/AzurionZzz/Environmental_Awareness_Pipeline/results/figures/styles/ieee_matlab.mplstyle`.
...
- capture root: `/Users/_iggnat_/Documents/TUe/Year 4/Q3/Team Internship/AzurionZzz/Environmental_Awareness_Pipeline/DepthCaptures_demo`
- results dir: `/Users/_iggnat_/Documents/TUe/Year 4/Q3/Team Internship/AzurionZzz/Environmental_Awareness_Pipeline/outputs/runs/demo_robust_20/camera_rig_metrics`
- depth stride: `1`
- metric scope: `roi`
- metrics rows: `20`
- semantic rows: `220`
